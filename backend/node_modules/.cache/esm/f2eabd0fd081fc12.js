let fs,express,swaggerUi,bodyParser,cors,InputError,AccessError,swaggerDocument,getEmailFromAuthorization,login,logout,register,getStore,setStore,save;_d08‍.x([["default",()=>_d08‍.o]]);_d08‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_d08‍.w("express",[["default",["express"],function(v){express=v}]]);_d08‍.w("swagger-ui-express",[["default",["swaggerUi"],function(v){swaggerUi=v}]]);_d08‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_d08‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_d08‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);_d08‍.w("../swagger.json",[["default",["swaggerDocument"],function(v){swaggerDocument=v}]]);_d08‍.w("./service",[["getEmailFromAuthorization",["getEmailFromAuthorization"],function(v){getEmailFromAuthorization=v}],["login",["login"],function(v){login=v}],["logout",["logout"],function(v){logout=v}],["register",["register"],function(v){register=v}],["getStore",["getStore"],function(v){getStore=v}],["setStore",["setStore"],function(v){setStore=v}],["save",["save"],function(v){save=v}]]);

let fs,jwt,AsyncLock,InputError,AccessError;_d08‍.x([["save",()=>save],["reset",()=>reset],["userLock",()=>userLock],["getEmailFromAuthorization",()=>getEmailFromAuthorization],["login",()=>login],["logout",()=>logout],["register",()=>register],["getStore",()=>getStore],["setStore",()=>setStore]]);_d08‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_d08‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_d08‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_d08‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);
